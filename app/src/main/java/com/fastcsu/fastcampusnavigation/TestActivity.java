...
//        }
    ...
    public void uploadPhoto(View v){
        ...
        if(building.getSelectedItem().toString().matches("") || floor.getText().toString().matches("")){
            ...
            Toast.makeText(TestActivity.this, "Please enter building intials and floor number before selecting a photo", Toast.LENGTH_LONG).show();
        }
        else{
            selectPhoto();
        }
        ...
        photoRef.putFile(file)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception exception) {
                        ...
                        Toast.makeText(TestActivity.this, exception.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });
    }
    ...
    class WifiReceiver extends BroadcastReceiver
    {
        public void onReceive(Context c, Intent intent)
        {
            ...
            if(building.getSelectedItem().toString().matches("") || floor.getText().toString().matches("")){
                ...
                Toast.makeText(TestActivity.this, "Please enter building intials and floor number (onReceive method)", Toast.LENGTH_LONG).show();
                return;
            }
            else{
            ...
            //TODO change this to floor you are viewing!
...
//                    iterator++;
            ...
            //stops wifi scan and calls function
...
//        }, 1000);
    ...
    class MyGestureDetector extends GestureDetector.SimpleOnGestureListener
    {
        ...
        public boolean onDoubleTap(MotionEvent e)
        {
            ...
            //doInback();
            Coordinates coords = new Coordinates(touchX,touchY);
            Toast.makeText(TestActivity.this, coords.toString(),Toast.LENGTH_SHORT).show();
            //p++;
    ...
    //test function for finding nearest landmark
    public void locate(View view){
        //DatabaseReference dinosaursRef = mDatabase.child("points");
        String floorAndNumber;
        if(building.getSelectedItem().toString().matches("") || floor.getText().toString().matches("")){

            Toast.makeText(TestActivity.this, "Please enter building intials and floor number (locate method)", Toast.LENGTH_LONG).show();
            return;
        }
        else{
            floorAndNumber = building.getSelectedItem().toString()+floor.getText().toString();
...
//                    Log.v("key", key);
//                    //loops through data(BSSID, sig_str) for each point
...
//                }
    ...
    public void compare(){
        ...
        if(building.getSelectedItem().toString().matches("") || floor.getText().toString().matches("")){
            ...
            Toast.makeText(TestActivity.this, "Please enter building intials and floor number (compare method)", Toast.LENGTH_LONG).show();
            return;
        }
        else{
            floorAndNumber = building.getSelectedItem().toString()+floor.getText().toString();
...
//                }
                ...
                float lowScore = 10000;
                String nearestCoords = "(0,0)";
                for (DataSnapshot alert: sig) {
                    float score = 0;
                    ...
                    //stored has more points then received scan
                    ...
                    //testing to see where my current point is in terms of KNN
                    if(score < 6000){
                        Pair<Float, String> pair = new Pair<>(score, key);
                        pairs.add(pair);
                    ...
                    //checking for new lowest score and closest point
                    if(score < lowScore){
                        //Pair<Float, String> pair = new Pair<>(score, key);
                        lowScore = score;
                        nearestCoords = key;
                ...
                String s = "";
                //creating a string to test knn
                for(int i = 0; i < pairs.size(); i++){
                    s += pairs.get(i).first.toString() + "->" + pairs.get(i).second.toString() + " ";
                    Log.d("pairs", pairs.get(i).first.toString() + " " + pairs.get(i).second.toString());
                }
                editTextTest.setText(s.toString());
                ...
                rssiRecieved.clear();
                bssidRecieved.clear();
                Toast.makeText(TestActivity.this,nearestCoords.toString(), Toast.LENGTH_LONG).show();
            }
